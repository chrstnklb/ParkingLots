...
module.exports.getDbConnection = function () {
    console.log("🚀 ~ file: db.js ~ getDbConnection")
...
module.exports.create = function (parkerlaubnis) {
    ...
    entry._id = ID_OF_ACTUAL_ENTRY;
    entry.letzteAenderung = time.createLetzteAenderung();
    entry.searchHash = buildSearchHash(parkerlaubnis);
...
module.exports.getErlaubnis = function (id) {
    console.log("🚀 ~ file: db.js ~ getErlaubnis")
    return connection
        .get(id)
        .then(function (doc) {
            return doc;
    ...
    return connection
        ...
        .then(function (doc) {
            (doc._id = idToBeUpdated),
                ...
                (doc.searchHash = buildSearchHash(parkerlaubnis));
...
module.exports.deleteAll = function () {
    console.log("🚀 ~ file: db.js ~ deleteAll")
    connection = this.getDbConnection();
...
function buildSearchHash(parkerlaubnis) {
